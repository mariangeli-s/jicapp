...
from utils.detection import mediapipe_detection, extract_keypoints, draw_changed_landmarks

# --- CONFIGURACIÓN DE LA APLICACIÓN FLASK ---
app = Flask(__name__)

# --- CONFIGURACIÓN DEL MODELO Y ACCIONES ---
MODEL_NAME = 'trad_aumentado_senias_txt.h5' 
...
# El orden es crucial.
actions = np.array(['hola', 'gracias', 'isabel'])
...
def generate_frames():
    ...
    with mp_holistic.Holistic(min_detection_confidence=0.5, min_tracking_confidence=0.5) as holistic:
        ...
        threshold_prediction_consistency = 0.9 # Umbral de confianza para añadir a la 'sentence' (tu 'threshold' original)
        ...
        while True:
            ...
            if len(sequence) == 30 and model is not None:
                ...
                # Lógica para el feedback visual de "BIEN HECHO" o "Inténtalo de nuevo..."
                feedback_text = ""
                feedback_color = (255, 255, 255) # Blanco por defecto

                if predicted_action_prob >= CONFIDENCE_THRESHOLD:
                    feedback_text = "¡BIEN HECHO! Sigue así."
                    feedback_color = (0, 255, 0) # Verde
                else:
                    feedback_text = "Inténtalo de nuevo..."
                    feedback_color = (0, 0, 255) # Rojo
                
                # Dibujar el texto de feedback en la parte inferior del frame
                cv2.putText(image, feedback_text, (50, 450), # Posición (x,y) en el frame
